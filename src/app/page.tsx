    ...
    <div className="container-fluid py-5">
      <header className="d-flex justify-content-between align-items-center mb-4">
        <div className="d-flex align-items-center gap-3">
          <img src="/komb-logo.png" alt="KOMU logo" style={{ width: 36, height: 36, objectFit: 'contain' }} />
          <span className="h5 mb-0">KOMU SmartPortal</span>
        </div>
      ...
      {/* (Realtime banner moved to layout so it shows site-wide) */}
          ...
          <div className="card p-4 shadow-sm border-0" style={{ background: 'linear-gradient(120deg, rgba(51,102,255,0.06), rgba(111,66,193,0.04))' }}>
            <div className="row align-items-center g-4">
              <div className="col-12 col-lg-7 text-start">
                  <h1 className="display-6 fw-bold">KOMU SMART PORTAL</h1>
                  <h1 className="display-6 fw-bold"> A smarter way to manage coursework</h1>
                  <p className="lead text-muted mb-3">Students and lecturers can now coordinate assignments, submit project topics for approval, upload work, and get real-time results and updates. KOMU brings transparency, automation, and a direct channel to ICT support.</p>
                <div className="d-flex gap-2">
                  ...
                  <Link href="/about" className="btn btn-outline-secondary btn-lg">About KOMU</Link>
                </div>
                  <div className="mt-3 small text-muted">Fix delays, confusion and stress — get instant results, project supervision tracking, and easy ICT communication.</div>
              </div>
                ...
                <div style={{ width: 260, margin: '0 auto' }}>
                  <div className="card p-3 shadow-sm border-0">
                    ...
                    <div className="mt-3 progress" style={{ height: 8, borderRadius: 8 }}>
                      <div className="progress-bar bg-primary" style={{ width: '78%' }} role="progressbar" aria-valuenow={78} aria-valuemin={0} aria-valuemax={100} aria-label="Assignment progress 78%" title="Assignment progress: 78%"></div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* Features */}
      <section className="mb-5">
        <h2 className="h4 mb-3 text-center">Why Choose KOMU?</h2>
        <div className="row g-3">
              ...
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body">
                  <div className="d-flex align-items-center gap-3 mb-3">
                    ...
                    <div className="mb-0 h5">{feature.title}</div>
                  </div>
      ...
      <footer className="text-center text-muted py-4">
        <small>&copy; 2025 KOMU SmartPortal. All rights reserved.</small>
      </footer>
    </div>
  )
}
